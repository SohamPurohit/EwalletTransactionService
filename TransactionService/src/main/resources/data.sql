...
insert into transaction (transactionid,phnnumber,amttransfer,balance,dateoftransfer,amtreceived,senderphnnumber,receiverphnnumber) values(2L,9782410575,0,50000,TO_DATE('02/06/2018', 'DD/MM/YYYY'),1000,9782410575,8955194111);
insert into transaction (transactionid,phnnumber,amttransfer,balance,dateoftransfer,amtreceived,senderphnnumber,receiverphnnumber) values(3L,8955194111,1000,30000,TO_DATE('02/06/2018', 'DD/MM/YYYY'),0,8955194111,9782410575);
